...
public class Facturas implements Serializable {
    ...
    public Facturas(int solicitud, int item, Date fecha,int cantidad) {
        this.facturasPK = new FacturasPK(solicitud, item, fecha,cantidad);
    }

    public Facturas(int solicitud, int item,int cantidad) {
        this.facturasPK = new FacturasPK(solicitud, item ,cantidad);
    }
