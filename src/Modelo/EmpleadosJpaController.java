...
public class EmpleadosJpaController implements Serializable {
    ...
    public void crearModeloEmpleados() {
        try {
            modelo2 = (new DefaultTableModel(
                    null, new String[]{
                        "cod_empleado", "Nombre",
                        "Salario", "Centro", "Responsable", "Jefe de Area"}) {
    ...
    public DefaultTableModel listarEmpleados(){
        crearModeloEmpleados();
        EmpleadosJpaController empleadosE = new EmpleadosJpaController();
        try{
            Object O[]=null;
            List<Empleados> e = empleadosE.findEmpleadosEntities();
            for (int i=0; i < e.size(); i++){
                modelo2.addRow(O);
                modelo2.setValueAt(e.get(i).getCodEmpleado(), i, 0);
                modelo2.setValueAt(e.get(i).getNombre(), i, 1);
                modelo2.setValueAt(e.get(i).getSalario(), i, 2);
                modelo2.setValueAt(e.get(i).getCentro(), i, 3);
                modelo2.setValueAt(e.get(i).getResponsable(), i, 4);
                modelo2.setValueAt(e.get(i).getJefeArea(), i, 5);
            }
    }catch (Exception e) {
